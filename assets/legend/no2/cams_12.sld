...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" version="1.0.0" xmlns:gml="http://www.opengis.net/gml" xmlns:sld="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc">
  <UserLayer>
    ...
    <sld:UserStyle>
      <sld:Name>bulgaria_CAMS_no2_2023_12</sld:Name>
              ...
              <sld:GrayChannel>
                ...
                <sld:ContrastEnhancement>
                  <sld:Normalize>
                    ...
                    <sld:VendorOption name="minValue">1.12537</sld:VendorOption>
                    <sld:VendorOption name="maxValue">24.9375</sld:VendorOption>
                  </sld:Normalize>
                </sld:ContrastEnhancement>
              </sld:GrayChannel>
            </sld:ChannelSelection>
